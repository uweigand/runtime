...
set __CMakeClrBuildSubsetArgs="-DCLR_CMAKE_BUILD_SUBSET_ILTOOLS=%__BuildILTools%" "-DCLR_CMAKE_BUILD_SUBSET_ALLJITS=%__BuildAllJits%" "-DCLR_CMAKE_BUILD_SUBSET_RUNTIME=%__BuildRuntime%"
