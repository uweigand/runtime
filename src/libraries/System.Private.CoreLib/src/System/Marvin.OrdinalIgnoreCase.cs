    ...
    internal static partial class Marvin
    {
        ...
        public static int ComputeHash32OrdinalIgnoreCase(ref char data, int count, uint p0, uint p1)
        {
            ...
            if (ucount > 0)
            {
                ...
                {
                    p0 += Utf16Utility.ConvertAllAsciiCharsInUInt32ToUppercase(tempValue) + 0x800000u;
                }
                else
                {
                    p0 += (Utf16Utility.ConvertAllAsciiCharsInUInt32ToUppercase(tempValue) << 16) + 0x8000u;
                }
            }
            else
            {
